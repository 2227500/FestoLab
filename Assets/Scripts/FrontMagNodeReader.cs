...
public class FrontMagNodeReader : MonoBehaviour
{
    ...
    public void NodeChanged(OPCUANodeSubscription sub, object value)
    {
       ...
       //Debug.Log("Robot Arm just registered " + nodeBeingMonitored + " as " + dataFromOPCUANode);
    }
    ...
    private void Update()
    {
        ...
        uiFeedbackTMP.text = "Back Magazine machine just registered " + factoryMachineID + " " + nodeBeingMonitored + " as " + dataFromOPCUANode;
    }
}
