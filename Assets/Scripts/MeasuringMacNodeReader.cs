...
public class MeasuringMacNodeReader : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        uiFeedbackTMP.text = "Measuring Machine registered " + factoryMachineID + " " + nodeBeingMonitored + " as " + dataFromOPCUANode;
    }
}
